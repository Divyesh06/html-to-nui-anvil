# NUI — Anvil UI in HTML

NUI lets you write Anvil UI in HTML, then convert it to a valid `form_template.yaml`. All logic stays in Python; no JavaScript is allowed in `design.html`.

This document is the canonical reference for any AI agent (or human) modifying NUI forms in this project.
